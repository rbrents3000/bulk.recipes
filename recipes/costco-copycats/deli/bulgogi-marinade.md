...
description: >-
  The raw marinated beef from the deli that turns any grill or skillet into a
  Korean BBQ joint. Now you control the marinade.
prep: 15 min
cook: 10 min
servings: '6'
cost: 3
...
dairy_free: false
costco_ingredients:
  - 'Beef Sirloin — 2 lbs, thinly sliced against the grain (~$9.99/lb)'
...
instructions:
  - >-
    Whisk together soy sauce, sesame oil, brown sugar, grated Asian pear,
    garlic, ginger, rice vinegar, black pepper, and the white parts of the green
    onions in a large bowl.
  - >-
    Taste the marinade — it should be savory-sweet with a little tang. Adjust
    the sugar or soy sauce to your liking.
  - >-
    Slice the beef as thinly as you can against the grain. Pop it in the freezer
    for 15-20 minutes first — partially frozen meat cooperates much better with
    a sharp knife.
  - >-
    Toss the beef into the marinade and make sure every piece is well coated.
    Cover tightly and refrigerate for at least 4 hours. Overnight is even better
    — the flavors deepen beautifully.
  - >-
    When you're ready to cook, pull the beef from the fridge 15 minutes before
    cooking to take the chill off.
  - >-
    Get your largest skillet, cast iron, or grill ripping hot over high heat.
    We're talking smoking hot — this is not a gentle sauté situation.
  - >-
    Add a thin layer of vegetable oil. Cook the beef in small batches — single
    layer, absolutely no crowding. About 2 minutes per side until caramelized
    and slightly charred at the edges.
  - >-
    Between batches, wipe out any burnt bits and add fresh oil. Crowding the pan
    steams the meat instead of searing it, and steamed bulgogi is a sad thing.
  - Cook your jasmine rice according to package directions while the beef rests.
  - >-
    Serve the bulgogi over fluffy rice, topped generously with sliced green
    onion tops and a heavy sprinkle of sesame seeds.
storage: >-
  Refrigerate cooked bulgogi for up to 3 days. The marinated raw beef keeps in
  the fridge for 2 days or in the freezer for up to 3 months. Freeze it flat in
  zip-lock bags for quick weeknight thaws — goes from frozen to ready in about
  20 minutes in a cold water bath.
leftover_ideas:
  - >-
    Pile into warm flour tortillas with kimchi and pickled cucumbers for Korean
    fusion tacos
  - >-
    Chop and fold into fried rice with a runny egg on top and a drizzle of
    gochujang
  - >-
    Stuff into crisp lettuce cups with gochujang mayo, quick-pickled carrots,
    and fresh cilantro
  - Layer into a cheesesteak-style hoagie with provolone and caramelized onions
  - >-
    Toss with cold noodles, cucumber, and a splash of extra sesame oil for a
    bulgogi noodle bowl
  - >-
    Top a bowl of steamed rice with bulgogi, a fried egg, and pickled radish for
    a quick bibimbap riff
nutrition:
  calories: 477
  protein: 37
  carbs: 31
...
**Prep:** 15 min + 4 hrs marinade | **Cook:** 10 min | **Servings:** 6 | **Cost:** ~$3.00/serving
...
> **Tip:** The Asian pear is the secret to Costco's bulgogi tenderness — the enzymes naturally tenderize the meat. If you can't find one, kiwi or pineapple juice works too (but less is more — too much turns it mushy in a hurry).
