...
description: >-
  Three Costco ingredients, 20 minutes, and you've got a meal that tastes like
  way more effort than it actually was. Kirkland pesto does the heavy lifting.
prep: 5 min
cook: 12 min
servings: '6'
cost: 2.33
...
instructions:
  - >-
    ...
    before draining.
  - >-
    Return drained pasta to the pot. Add pesto, shredded chicken, and a splash
    of pasta water. Toss until everything is coated.
  - Add cherry tomatoes if using. Season with salt and pepper.
  - Serve topped with Parmesan and toasted pine nuts.
storage: >-
  Refrigerate up to 3 days. Add a splash of olive oil when reheating to loosen
  the pesto.
leftover_ideas:
...
**Prep:** 5 min | **Cook:** 12 min | **Servings:** 6 | **Cost:** ~$2.33/serving
...
2. Return drained pasta to the pot. Add pesto, shredded chicken, and a splash of pasta water. Toss until everything is coated.
