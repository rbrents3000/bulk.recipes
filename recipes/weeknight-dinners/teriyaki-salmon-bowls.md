...
description: >-
  Sticky teriyaki-glazed Costco salmon over rice with edamame and cool cucumber
  — the dinner bowl that makes weeknights feel oddly put-together.
prep: 10 min
cook: 15 min
servings: '4'
cost: 5
...
costco_ingredients:
  - >-
    Kirkland Signature Frozen Atlantic Salmon Fillets — 4 fillets (~$22.99, 3 lb
    bag)
  - 'Kirkland Signature Jasmine Rice — 2 cups dry (~$14.99, 25 lb bag)'
  - 'Kirkland Signature Shelled Edamame (frozen) — 1.5 cups (~$8.99, 3 lb bag)'
...
instructions:
  - >-
    Cook rice according to package directions. About 2 cups dry rice will yield
    enough for 4 bowls. Microwave edamame according to package directions and
    set aside.
  - >-
    Thaw salmon fillets if frozen — run them under cool water for 5 minutes or
    thaw overnight in the fridge. Pat completely dry with paper towels.
  - >-
    Make the teriyaki glaze: whisk together soy sauce, honey, rice vinegar,
    ginger, and garlic in a small bowl.
  - >-
    Heat sesame oil in a large nonstick skillet over medium-high heat. Place
    salmon fillets skin-side up and sear for 3-4 minutes until golden. Flip and
    cook another 3 minutes.
  - >-
    Pour the teriyaki glaze around the salmon. Let it simmer for 1-2 minutes,
    then stir in the cornstarch slurry. Cook until the sauce thickens and coats
    the back of a spoon, about 1 minute more. Spoon glaze over the fillets as it
    thickens.
  - >-
    Build bowls: rice on the bottom, salmon fillet on top, edamame and cucumber
    on the sides. Drizzle remaining glaze from the pan over everything. Finish
    with sesame seeds and sliced green onions.
storage: >-
  Store components separately in the fridge for up to 3 days. The salmon reheats
  best in a 300°F oven for 8-10 minutes. Rice and edamame microwave fine. You
  can freeze the rice and salmon (without fresh toppings) for up to 1 month —
...
**Prep:** 10 min | **Cook:** 15 min | **Servings:** 4 | **Cost:** ~$5.00/serving

## Costco Shopping List
- Kirkland Signature Frozen Atlantic Salmon Fillets — 4 fillets (~$22.99, 3 lb bag)
- Kirkland Signature Jasmine Rice — 2 cups dry (~$14.99, 25 lb bag)
- Kirkland Signature Shelled Edamame (frozen) — 1.5 cups (~$8.99, 3 lb bag)
- Kirkland Signature Sesame Oil — 1 tablespoon (~$8.49, 20 oz bottle)
