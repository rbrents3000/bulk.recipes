...
| Bibimbap Kit | ₩11,900 | ~$9.00 | Rice, seasoned vegetables (spinach, bean sprouts, carrots, zucchini), gochujang sauce, and protein — assemble at home. Add a fried egg on top and you're golden. |

### Seafood

| Item | Price (₩) | Price (~USD) | Description |
|------|-----------|-------------|-------------|
| Sashimi Platter | ₩19,900 | ~$15.10 | Assorted fresh sashimi |
| Grilled Eel (Unagi) | ₩15,900 | ~$12.10 | Ready-to-eat grilled eel |
| Seafood Pajeon Mix | ₩11,900 | ~$9.00 | Korean seafood pancake kit |

### Sides & Banchan

The banchan game is strong. These are the ready-to-eat Korean side dishes that round out any meal.

| Item | Price (₩) | Price (~USD) | Description |
|------|-----------|-------------|-------------|
| Kimchi | ₩11,900 | ~$9.00 | Large container of traditional napa cabbage kimchi — properly fermented, good funk |
| Kkakdugi (Cubed Radish Kimchi) | ₩9,990 | ~$7.60 | Crunchy cubed radish kimchi — tangier and crunchier than cabbage kimchi |
| Seasoned Bean Sprouts (Kongnamul) | ₩6,990 | ~$5.30 | Sesame-dressed soybean sprouts — a staple banchan |
| Seasoned Spinach (Sigeumchi) | ₩6,990 | ~$5.30 | Blanched spinach with sesame oil and garlic — classic side |
| Korean Potato Salad | ₩8,990 | ~$6.80 | Sweeter and creamier than American-style, with apple and cucumber bits. Unexpectedly addictive. |
| Pickled Radish (Danmuji) | ₩5,990 | ~$4.50 | Sweet yellow pickled radish — the essential gimbap companion |
| Japchae (Side Portion) | ₩7,990 | ~$6.10 | Smaller japchae portion, banchan-sized |

### Seasonal & Holiday Items

- **Chuseok (Korean Thanksgiving):** Special gift sets with galbi, bulgogi, and fruit appear in September. The galbi gift sets are hugely popular.
- **Lunar New Year:** Tteokguk (rice cake soup) kits and mandu (dumpling) platters.
- **Summer:** Naengmyeon (cold noodle) kits, lighter seafood options.
- **Winter:** Heavier stew kits (kimchi jjigae, sundubu jjigae), braised short rib sets.

## Shared Items

Standard US items also available:
- Rotisserie Chicken — same price miracle
- Caesar Salad Kit
- Mac and Cheese
- Meatloaf
